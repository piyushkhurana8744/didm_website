...
export default function AboutPage() {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const res = await fetch("/api/content?path=/about");
  ...
  const statsSection = pageData?.sections?.find((s: any) => s.type === "features");
  ...
  return (
    <main className="min-h-screen bg-white font-sans">
      ...
      {/* Dynamic Driving Excellence Section */}
      {aboutSection && (
      ...
      {/* Render additional dynamic sections */}
